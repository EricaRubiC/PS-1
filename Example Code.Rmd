...
Most of the participants view on China’s political and economic influence on Uganda is positive, with 46.8% expressing favorable opinions along Somewhat Positive (27%) and Very Positive (19.8%). Yet, 25.5% of respondents responded as being uncertain and negative perceptions are an overall 23.7%, with Somewhat Negative (12%) and Very Negative (11.7%) responses.
...
Most of the participants view on the United State’s political and economic influence on Uganda is uncertain with 34% of all respondents answering "don't know". For positive attitudes, Somewhat Positive (27.8%) and Very Positive (17.1%) make 44.9% of total positive feelings. Negative perceptions are an overall 14.8%, with Somewhat Negative (9.7%) and Very Negative (5.1%) responses.
...
test_result <- t.test(PSData$Q78A, PSData$Q78B, paired = TRUE)
...
knitr::kable(test_summary, caption = "Paired T-Test Results", align = 'l', col.names = c("Metric", "Value"))
```
